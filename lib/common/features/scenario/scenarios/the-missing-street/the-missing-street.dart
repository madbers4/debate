...
final Scenario theMissingStreet = Scenario(
    ...
    acts: [
      ScenarioAct(
          ...
          title: 'Обвинение',
          description:
              'Бюро урбанистического развития имеет причины полагать, что ваш подзащитный скопировал нашу карту и выдал за свою. Мы добавили на свою карту поддельную улицу, чтобы сразу было видно, если карту кто-то скопирует. Этой улицы просто не существует, на ее месте сейчас находится большой пустырь. Вот фотография пустыря из городского архива, которая это доказывает. ',
          events: [
            ScenarioEvent(
      ...
      ScenarioAct(
          ...
          events: [
            ScenarioEvent(
                id: 'БУР пронзает небеса!',
                title: 'БУР пронзает небеса!',
                description:
      ...
      ScenarioAct(
          ...
          title: 'Адрес',
          description:
              'Предположим, что это и правда улица, и я правда купил_а там круассан. Но вы скопировали на свою карту не только расположение, но и название улицы! Как вы можете доказать, что эта улица и в самом деле так называется? На пакете из пекарни адреса нет.',
          events: [
            ScenarioFalsyEvent(
                id: 'Улица',
                title: 'Улица',
      ...
      ScenarioAct(
          ...
          events: [
            ScenarioEvent(
                ...
                title: 'Роза',
                description:
                    'Из салфетки можно сложить розочку. И подарить ее прокурору.'),
            ScenarioFalsyEvent(
    ...
    evedences: [
      ...
      ScenarioEvedence(
          ...
          description:
              'Пустая коробка из-под тонизирующего чая из Лиюэ, выпитого в процессе создания карты.'),
      ScenarioEvedence(
          id: 'Архив',
          title: 'Архив',
          description:
        ...
        TransitionEventAddEvedencesEffect(
          ...
          evedences: [
            ...
            ScenarioTruthyEvedence(
              ...
              title: 'Пакет',
              description: 'Пакет с логотипом пекарни, котороый оставил судья.',
            ...
            TransitionEventAddEvedencesEffect(
              ...
              evedences: [
                ...
                ScenarioEvedence(
                    id: 'Карта',
                    title: 'Карта',
                    description: 'Для игры в Священый призыв семерых.'),
                ScenarioTruthyEvedence(
                    id: 'Салфетка',
                    title: 'Салфетка',
