      ...
      ScenarioAct(
          ...
          events: [
            ...
            ScenarioEvent(
                ...
                title: 'Костюмы',
                description:
                    'Используя подобные текстуры, было созданно несколько костюмов назаказ.'),
          ]),
      ScenarioAct(
          id: actTwoId,
          title: 'Пропорции',
          description:
              'Хорошо, если для вас этого не достаточно... Дом Тиори использует пропорции золотого сечения для создания гармоничного силуэта, также и в подкладках с прямоугольниками, это нарушение авторский прав.',
          events: [
            ScenarioEvent(
                id: '1.618',
                title: '1.618',
        ...
        TransitionEventAddEvedencesEffect(
          ...
          evedences: [
            ...
            ScenarioEvedence(
                ...
                title: 'Отличия',
                description:
                    'Измерены ли пропорции с нужной точностью, чтобы подтвердить соответстие?'),
          ],
        ),
      ]),
      TransitionEvent(id: 'Все живое', nextActId: actThreeId, effects: [
        TransitionEventRemoveEvedenceEffect(
            id: generateUID(), evedenceIds: ['Фибоначчи', 'Отличия']),
        TransitionEventAddEvedencesEffect(
          id: generateUID(),
          evedences: [
            ScenarioEvedence(
                ...
                title: 'Любовь',
                description:
                    'Фарузан очень любит своих учеников. Наврятли она бы стала дарить контрафактные костюмы.'),
            ScenarioEvedence(
                id: 'Кутюрье',
                title: 'Кутюрье',
                description:
            ...
            ScenarioTruthyEvedence(
                ...
                description:
                    'Каталог модного дома золотого сечения, где каждая эмблема выполнена из золота или материала или его имитируещего.'),
            ScenarioEvedence(
                id: 'Дело',
                title: 'Дело',
                description:
