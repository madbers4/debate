...
final Scenario maskarad = Scenario(
    ...
    defendant: ScenarioDefendant(
        ...
        name: 'Мелюзина',
        description:
            'По словам свидетелей, вазу разбил один из «хиличурлов». Обвиняемый посетил бал в костюме хиличурла. Тут всё очевидно.',
          ...
          effects: [
            ...
            TransitionEventAddEvedencesEffect(
              ...
              evedences: [
                ...
                ScenarioEvedence(
                    id: 'Хиличурий разговорник',
                    title: 'Хиличурий разговорник',
                    description: 'Выпал из-за пояса вашего товарища.'),
                ScenarioEvedence(
                    id: 'Фиолетовые ноги',
                    title: 'Фиолетовые ноги',
                    description:
                        'Вашего собеседника — это всё, что вы видели весь вечер.'),
              ],
            ),
          ]),
      TransitionEvent(
